        ...
        <div class="p-fluid formgrid grid">
            ...
            <template v-if="isFile">
                <div class="field col-12">
                    <label for="path">{{ $t('documents.upload_files') }}</label>
                    <VaporUpload
                ...
                <div class="field col-12" v-if="uploadedFiles.length">
                    <h5 class="mb-3">{{ uploadedFiles.length }} Files</h5>
                    <Card
                    ...
                    >
                        <template #content>
                            ...
                            <div class="p-fluid formgrid grid mt-3">
                                ...
                                >
                                    <label for="path">Parent Folder</label>
                                    <TreeSelect
            ...
            <template v-else>
                <div class="field col-12">
                    <label for="path">{{ $t('documents.folder_name') }}</label>
                    <InputText
                        id="path"
                        v-model="folderName"
