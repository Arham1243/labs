...
<template>
    <div>
        ...
        <form @submit.prevent="verifyCode">
            <div class="pt-3 grid p-fluid formgrid">
            ...
            <div class="flex align-items-center justify-content-center mb-5">
                <div class="flex align-items-center text-base font-bold">
                    <span
                        class="d-flex text-600"
            ...
            <div
                class="flex flex-column flex-wrap gap-3 justify-content-between"
            >
                <Button
