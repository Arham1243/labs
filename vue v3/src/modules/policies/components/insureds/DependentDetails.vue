...
<template>
    ...
    <div v-else class="grid mt-1">
        ...
        <div class="sm:col-6 md:col-8 text-sm py-1">{{ passportNumber }}</div>

        <div class="sm:col-6 md:col-4 text-sm font-semibold py-1">
            {{ $t('insured_overview.applicant.primary_email') }}
        </div>
        <div class="sm:col-6 md:col-8 text-sm py-1">{{ email }}</div>

        <div class="sm:col-6 md:col-4 text-sm font-semibold py-1">
            {{ $t('insured_overview.applicant.secondary_email') }}
        </div>
        <div class="sm:col-6 md:col-8 text-sm py-1">{{ secondaryEmail }}</div>

        <div class="sm:col-6 md:col-4 text-sm font-semibold py-1">
            {{ $t('insured_overview.applicant.preferred_language') }}
        </div>
        <div class="sm:col-6 md:col-8 text-sm py-1">English</div>
    </div>
</template>
