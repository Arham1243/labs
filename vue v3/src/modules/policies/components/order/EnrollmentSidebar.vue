...
<template>
    ...
    >
        <template #header>
            <div class="custom-header relative inline-flex align-items-center">
                <Button
                    v-if="isEditView"
                    severity="danger"
        ...
        <div
            v-if="isLoadingForm"
            class="absolute w-full h-full bg-gray-200 opacity-50 flex items-center justify-center z-5"
        >
            <ProgressSpinner />
        </div>
        <div class="my-3">
            <SelectButton
                ...
                :pt="{
                    button: () => ({
                        class: 'col-6 flex justify-content-center'
                    }),
                    root: {
        ...
        <div class="enrollment-section">
            ...
            <div class="mt-3 grid p-fluid formgrid">
                <div class="field col-12">
                    <label for="applicant_type_id" data-testid="type-label"
                ...
                <div class="field col-12" v-if="isDependentForm">
        ...
        <div class="enrollment-section" v-if="isApplicantDetailsValid">
            ...
            <div class="mt-3 grid p-fluid formgrid">
                ...
                <div class="col-12 mb-0" v-if="enrollment.isEnforced">
