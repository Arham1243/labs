...
const getItem = async () => {
    const params = { include: 'client,contacts.contactType' };
...
const goBack = () => {
    router.push({ name: 'New Business Unit Step 2', params: { id: props.id } });
};

const goNext = () => {
    router.push({ name: 'New Business Unit Step 4', params: { id: props.id } });
};
</script>
...
<template>
    ...
    <div v-else>
            ...
            <div class="col-8 mx-auto">
                <Card>
                    <template #content>
                        ...
                        <div
                            data-testid="holding-contact-info-label"
                        ...
                        <div v-if="item.contacts.length > 0">
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <div
                                            class="flex justify-content-start align-item-center gap-3 mb-2"
                                        >
                                            <div
                                ...
                                <hr v-if="index !== item.contacts.length - 1" />
                            </div>
                        </div>
        ...
        />
        <Confirmation
            v-if="deleteDialog && $ability.can('delete business units')"
