...
<template>
    ...
    >
        ...
        <div class="flex align-items-center justify-content-between my-4">
            <div class="flex align-items-ceneter gap-3">
                <span
        ...
        <div
            ...
            class="flex justify-content-between gap-3 pt-6"
        >
            <Button
                ...
                icon="pi pi-check"
                label="Approve"
                class="flex gap-1 justify-content-center border-none w-full"
    ...
    >
        <template #header>
            <div class="flex align-items-center justify-content-between w-full">
                ...
                <Button
                    icon="pi pi-times"
                    class="p-confirm-header-close border-none p-button-outlined p-2 border-circle"
