...
<template>
    ...
    <Card class="mb-3 cursor-pointer px-0 pb-0" @click="goToView()">
        <template #title>
            <div
        ...
        <template #subtitle>
            <div data-testid="plan-details-label" class="mb-1 px-4">
                {{ $t('plans.' + plan.bound) }} •
                {{ $t('plans.' + plan.type) }}
                {{
            ...
            <div data-testid="effective-date-label" class="px-4">
