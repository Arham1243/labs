...
<template>
    ...
    <div v-else>
        ...
        <div v-if="!isEditing">
            <div v-if="variant !== 'businessUnit'" class="grid mt-1">
                <div
                ...
                <div class="col-9 text-sm py-1 p-break-all">
                    {{ item.address }}
                </div>
                <div
            ...
            <div v-if="variant === 'businessUnit'" class="grid mt-1">
                <div class="col-3 text-sm font-semibold py-1">Address:</div>
                <div class="col-9 text-sm py-1 p-break-all">
                    {{ item.location_details?.address }}
                </div>
                <div class="col-3 text-sm font-semibold py-1">Address 2:</div>
                <div class="col-9 text-sm py-1 p-break-all">
                    {{ item.location_details?.address2 }}
                </div>
                <div class="col-3 text-sm font-semibold py-1">Country:</div>
                <div class="col-9 text-sm py-1 p-break-all">
                    {{ item.location_details?.country?.name }}
                </div>
                <div class="col-3 text-sm font-semibold py-1">
                    Province/State:
                </div>
                <div class="col-9 text-sm py-1 p-break-all">
                    {{ item.location_details?.province?.name }}
                </div>
                <div class="col-3 text-sm font-semibold py-1">City:</div>
                <div class="col-9 text-sm py-1 p-break-all">
