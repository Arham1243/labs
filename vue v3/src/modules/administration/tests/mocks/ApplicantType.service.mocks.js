...
import * as ApplicantTypeService from '@/modules/administration/services/ApplicantType.service';

export const searchApplicantTypeMock = () =>
    vi.spyOn(ApplicantTypeService, 'search').mockResolvedValue({
        data: {
            data: [
                {
