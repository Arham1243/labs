...
import * as ContactSourceService from '@/modules/administration/services/ContactSource.service';

export const searchContactSourceMock = () =>
    vi.spyOn(ContactSourceService, 'search').mockResolvedValue({
        data: {
            data: [
                {
