...
<template>
    <li class="setting list-none" v-bind="$attrs">
        <router-link
            ...
            "
            class="setting-item flex align-items-center"
        >
            <div class="setting-item__details flex align-items-center gap-4">
                <div
                    class="icon flex justify-content-center align-items-center border-circle"
                >
                    <i
