...
<template>
    <div class="treetable-scroll-wrapper">
        ...
        >
            ...
            <Column class="col-drag text-center w-0 p-0">
                <template #body="{ node }">
                    <img
                        ...
                        style="width: 17px; height: 19px; margin-left: 1.25rem"
                        draggable="true"
            ...
            >
                ...
                <template #body="{ node }">
                    <div class="flex align-items-center gap-3">
                        <i
                            :class="`text-4xl text-primary ${node.data.icon}`"
                        ></i>
                        <span
    ...
    >
        ...
        <div class="p-fluid formgrid grid">
            ...
            <div class="field col-12 mb-4" v-if="showParentMenuField">
                <label
                    class="block required mb-2"
                    for="type"
...
.menu-treetable .p-treetable-toggler {
    margin-right: 0.95rem !important;
    overflow: initial !important;
    width: 30px !important;
    height: 30px !important;
}
.hide-dropdown-icon .p-dropdown-trigger {
