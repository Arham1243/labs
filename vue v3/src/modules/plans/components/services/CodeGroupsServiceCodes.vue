...
<template>
    <div>
        ...
        <div v-if="isEditable" class="flex align-items-center mb-2">
            <ApiMultiselect
                id="template"
                filter
                option-label="name"
        ...
        <TabView :key="refresh">
            <TabPanel :header="`Included (${includedServiceCodesCount})`">
                <ServiceCodesTable
                    :id="id"
                    entity="groups"
                    :key="inclRefresh"
            ...
            <TabPanel :header="`Excluded (${excludedServiceCodesCount})`">
                <ServiceCodesTable
                    :id="id"
                    excluded
                    entity="groups"
