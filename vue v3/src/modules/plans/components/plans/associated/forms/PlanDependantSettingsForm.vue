...
<template>
    <div class="p-fluid formgrid grid mt-4">
        <div class="field flex flex-wrap align-items-center col-12">
            ...
            <InputNumber
                ...
                class="md:w-10rem ml-5 text-center"
                :min="0"
                :max="99"
            >
        ...
        >
            <div v-for="(item, i) in formData.pricing_discounts" :key="i">
                <div class="flex flex-wrap align-items-center gap-3 mb-3">
                    ...
                    <div class="field flex-shrink-0 ml-auto">
            ...
            <div class="flex justify-content-end md:col-12">
                <div class="flex">
                    <Button
        ...
        <div v-if="formData.restrict_eligibility">
            <div
                class="field md:col-12 flex align-items-center flex-wrap gap-3 md:ml-6"
            >
                <div>
        ...
        <div class="field col-12 flex flex-wrap align-items-center gap-3">
            <div>
        ...
        <div v-if="formData.time_limit" class="col-12">
            <div class="my-4 ml-6">
                <div
                    v-if="periods.length === 0"
                    class="mt-4 p-3 message-danger"
                >
            ...
            <div
                class="field col-12 flex flex-wrap align-items-center gap-3 pl-6"
            >
                <div>
