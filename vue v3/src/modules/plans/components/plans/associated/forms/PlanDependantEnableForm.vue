...
<template>
    <div class="p-fluid formgrid grid mt-4">
                ...
                <div class="mt-5">
                    <div class="ml-6">
                        ...
                        <div
                            ...
                            class="mt-4 flex align-items-center gap-3"
                        >
                            <div>
        ...
        <div class="field col-12">
            ...
            <div class="mt-5" v-if="formData.is_spouse">
                <div class="ml-6">
                    <InputField
                        id="is_checked"
                        variant="checkbox"
        ...
        <div class="field col-12">
            ...
            <div class="ml-10" v-if="formData.is_child">
                <table class="border-collapse ml-6">
                    <tbody>
                        <tr>
                ...
                <div class="ml-6" v-if="formData.is_time_limit_child">
                    <div
                        v-if="periods.length === 0"
                        class="mt-4 p-3 message-danger"
                    >
