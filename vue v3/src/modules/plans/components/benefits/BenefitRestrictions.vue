...
<template>
    ...
    <div v-else>
        ...
        <div v-else class="grid mt-1">
            <div class="col-4 text-sm font-semibold py-1">
            ...
            <template v-if="item.is_individual">
                <div class="col-4 text-sm font-semibold py-1">Inbound</div>
                <div class="col-8 text-sm py-1">
            ...
            <div class="col-8 text-sm py-1 flex flex-column gap-2">
            ...
            <div class="col-4 text-sm font-semibold py-1">Report to Vendor</div>
            <div class="col-8 text-sm py-1">
                {{
            ...
            <div class="col-4 text-sm font-semibold py-1">Note</div>
            <div class="col-8 text-sm py-1 p-break-all">
                {{ item.note }}
            </div>
        </div>
    </div>
