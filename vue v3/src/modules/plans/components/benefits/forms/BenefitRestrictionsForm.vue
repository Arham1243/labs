...
<template>
    <div class="p-fluid formgrid grid mt-4">
        ...
        <div class="field col-12">
            <div class="flex mt-3">
                <InputSwitch v-model="formData.isIncludeSupply" />
            ...
            <div v-if="formData.isIncludeSupply">
                <div v-for="(rule, index) in formData.rules" :key="index">
                    <div
                        class="flex col-12 align-items-center mt-2 py-4 custom-card"
                    >
                        <div class="col-11">
                            <div class="flex">
                                <div class="col-2">
                            ...
                            <div class="col-12">
                                <!--BG is in development - need to add the API reference -->
                                <InputField
        ...
        <div class="field col-12">
            <div class="flex mt-3">
                <InputSwitch v-model="formData.isTimeRequirement" />
                <span class="ml-2">
            ...
            <div
                ...
                class="p-fluid formgrid grid align-items-start mt-3"
            >
                <div class="col-3">
                    <InputField
                        variant="dropdown"
        ...
        <div class="field col-12">
            <div class="flex mt-3">
                <InputSwitch v-model="formData.is_reportable_to_vendors" />
                <span class="ml-2"> Report to vendor </span>
            </div>
            <div
                v-if="formData.is_reportable_to_vendors"
                class="grid mt-3 align-items-center"
            >
                <div class="col-12">
                    <InputField
                        showClear
