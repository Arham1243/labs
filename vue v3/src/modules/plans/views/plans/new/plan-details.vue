...
<template>
    <Loader v-if="loading" />
    <div v-else>
        <div class="p-fluid formgrid grid mt-4 mb-8 mx-8">
            <div class="col-8">
                <Card class="mb-3">
                    <template #content>
                        <div class="flex justify-content-between">
                            <h5 data-testid="plan-details-title" class="mb-3">
                ...
                <Card class="mb-3">
                    <template #content>
                        <h5 data-testid="set-period-dates-title" class="mb-3">
                ...
                <Card class="mb-3">
                    <template #content>
                        <h5 data-testid="set-policy-actions-title" class="mb-3">
                ...
                <Card class="mb-3">
                    <template #content>
                        <h5 data-testid="policy-defaults-title" class="mb-3">
        ...
        >
            ...
            >
                <div class="field col-12">
                    <label for="client" class="mr-3 my-3"
                        >{{ $t('common.client') }}
                    </label>
                    <ApiDropdown
                        id="client"
                ...
                <div class="field col-6" v-show="selectedClient">
                    <label for="plan" class="mr-3"
                        >{{ $t('common.plan') }}
                    </label>
                    <ApiDropdown
                        id="plan"
                ...
                <div class="field col-6" v-show="selectedClient">
                    <label for="business_unit" class="mr-3"
