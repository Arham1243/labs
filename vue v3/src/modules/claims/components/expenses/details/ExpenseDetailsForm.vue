...
<template>
    <div class="p-fluid formgrid grid mt-4">
        <div class="field col-12">
            <label data-testid="label-benefit">{{
                $t('common.benefit')
            }}</label>
            <Dropdown
        ...
        <div class="field col-12">
            <label data-testid="label-service-code">{{
        ...
        <div class="field col-12">
            <label data-testid="label-service-date">{{
        ...
        <div class="field col-6">
            <label data-testid="label-expense-amt">{{
            ...
            />
            <small class="p-error" v-if="errors.amount_claimed">{{
        ...
        <div class="field col-12">
            <label data-testid="label-beneficiary">{{
                $t('expenses.beneficiary')
            }}</label>
            <ApiDropdown data-testid="dropdown-beneficiary" :items="[]" />
        </div>
        <div class="field col-12">
            <label data-testid="label-description">{{
