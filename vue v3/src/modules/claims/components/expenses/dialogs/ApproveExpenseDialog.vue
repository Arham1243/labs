...
<template>
    ...
    >
        ...
        <div>
            ...
            <div class="grid mt-3 justify-items-center">
                <div
            ...
            <div class="grid mt-1">
                ...
                <div class="col-2 py-1 p-break-word">
                    <InputNumber
                        suffix=" %"
                ...
                <div class="col-3 py-1 p-break-word">
                    <InputNumber
                        prefix="$ "
                        suffix=" CAD"
                        :minFractionDigits="2"
        ...
        <template #footer>
            <div class="flex items-center">
                ...
                />
                <label for="is_courtesy_pay" class="ml-2"> Courtesy Pay </label>
            </div>
            <div v-if="is_courtesy_pay" class="mt-3 mb-3">
                <label for="courtesy_reason" class="flex font-bold mb-3">
