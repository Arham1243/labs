...
<template>
    <div>
        <div class="flex my-2 justify-content-between" v-if="!minimal">
            <div
        ...
        <div
            class="flex w-full border-round-xl overflow-hidden"
        ...
        >
            <div
                ...
                class="h-1rem"
                :class="{
                    'border-right-2 border-white':
                        amt.percent && amt.label !== 'Reserved Amount'
                }"
        ...
        <div class="my-3 text-sm" v-if="expenseDetail && minimal">
            <div
                ...
                :key="key"
                class="flex gap-4 justify-content-between"
                :class="{
