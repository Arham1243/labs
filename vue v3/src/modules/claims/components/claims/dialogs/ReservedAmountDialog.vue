    ...
    >
        ...
        <div class="mb-3">
            ...
            <div class="flex items-center gap-4">
                <label
                    class="font-semibold w-14rem col-4 white-space-nowrap pl-0"
            ...
            <div class="flex items-center gap-4">
                <label
                    class="font-semibold w-14rem white-space-nowrap col-4 pl-0"
        ...
        <div class="flex gap-4 mb-6 align-items-center">
            <label
                for="reserved-amount-input"
                class="font-semibold w-14rem white-space-nowrap col-4 pl-0"
            >
            ...
            <div class="col-8 pl-0">
                <InputField
                    ...
                    class="reserved-amt-input flex-grow"
                />
                <small
        ...
        <div>
            <label
                for="reason-textarea"
                class="block mb-1 font-semibold w-10rem white-space-nowrap"
            >
                Reason:
            </label>
            <Textarea
