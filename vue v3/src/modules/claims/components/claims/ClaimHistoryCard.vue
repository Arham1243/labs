...
<template>
    <div>
        <div
            class="flex align-items-center justify-content-between filter-bg pt-3 pl-3 pr-3 mb-3"
        >
            <div
                class="flex align-items-center justify-content-between gap-2 pb-3"
            >
                <Search
                    v-model="searchText"
                    @search="search"
        ...
        <div class="grid mt-2">
            <div class="col-3">
                ...
                >
                    <div
                        class="policy-container border-solid border-round-lg border-1 p-3"
                    >
                        <a
                        ...
                        <div
                            ...
                            :class="[
                                activeClaim?.id === claim.id
                                    ? 'border-solid border-round-lg border-2 border-primary-200 p-3 cursor-pointer mt-3 claim-history-card-bg shadow-2'
                                    : 'border-solid border-round-lg border-1 border-gray-200 p-3 cursor-pointer mt-3'
                            ]"
            ...
            <div class="col-9">
                <div
                    ...
                    class="flex flex-column align-items-center mt-8"
                >
                    <i
                    ...
                    <h5
                        ...
                        class="font-normal mt-2 text-gray-500"
                    >
                        ...
                        <div>
                            <Button
                                ...
                                :label="
                                    props.isFromClaim
                                        ? $t(
                                              'claims.attach_submissions_to_claim'
                                          )
                                        : $t(
                                              'claims.attach_submission_to_claim'
                                          )
                                "
                            ...
                            <Confirmation
                                ...
                                :header="
                                    $t(
                                        'claims.attach_submissions_to_claim_title'
                                    )
                                "
