    ...
    <Card>
        <template #content>
            <div>
                <div class="flex justify-content-between align-items-center">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div
                                class="flex justify-content-between gap-2 mt-2 underline cursor-pointer"
                                data-testid="text-submission-receiveDate-source"
                            >
                ...
                <div
                    class="flex justify-content-between align-items-center bg-gray-100 rounded m-4 p-3"
                    v-if="
                        currentSubmission.queue?.audit_status ===
                        auditStatus.audited_pending
                    "
                >
                    <h5 class="flex align-items-center gap-2">
                        <svg
                            width="20"
                            height="21"
                            viewBox="0 0 20 21"
                    ...
                    <div
                        class="flex justify-content-between gap-2 mt-2 cursor-pointer"
                    >
                        <Button
                            class="cursor-pointer border-0 pl-5 pr-5 bg-green-500"
                        ...
                        />
                        <Button
                            class="cursor-pointer border-0 pl-5 pr-5 bg-red-500"
                ...
                >
                    <TabPanel>
                        <template #header>
                            ...
                            <Badge
                                v-if="currentSubmission.expenses?.length"
                                :value="currentSubmission.expenses.length"
                                class="ml-1"
                                :class="{
                                    'p-badge-secondary': activeTab !== 0
                                }"
                                data-testid="badge-expenses-count"
                            />
                        </template>
                        <ClaimBaseTable
                            :payload="[
