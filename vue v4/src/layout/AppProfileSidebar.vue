...
<template>
    <Drawer
        ...
        :pt="{
        root: {
            style: 'width: 25rem; max-width: 30rem;'
        }
    }"
    >
        <template #header>
        ...
        <div class="flex flex-col mx-auto md:mx-0">
            <span class="mb-2 font-bold">Welcome</span>
            <span class="text-color-secondary font-medium mb-5">{{ currentUser?.name }}</span>

            <ul class="list-none m-0 p-0">
                <li>
                    <a
                        data-testid="profile-link"
                        class="cursor-pointer flex mb-3 p-3 items-center border border-surface-200 dark:border-surface-700 rounded hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors duration-150"
                    >
                        <span>
        ...
        <div class="flex flex-col mt-8 mx-auto md:mx-0">
            ...
            <ul class="list-none m-0 p-0">
                <li>
                    <a class="cursor-pointer flex mb-3 p-3 items-center border border-surface-200 dark:border-surface-700 rounded hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors duration-150">
                        <span>
        ...
        <div class="flex flex-col mt-8 mx-auto md:mx-0">
            ...
            <ul class="list-none m-0 p-0">
                <li>
                    <a class="cursor-pointer flex mb-3 p-3 items-center border border-surface-200 dark:border-surface-700 rounded hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors duration-150">
                        <span> <img src="/demo/images/avatar/circle/avatar-m-8.png" alt="Avatar" class="w-1/2" /> </span>
                        <div class="ml-3">
                ...
                <li>
                    <a class="cursor-pointer flex mb-3 p-3 items-center border border-surface-200 dark:border-surface-700 rounded hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors duration-150">
                        <span> <img src="/demo/images/avatar/circle/avatar-f-8.png" alt="Avatar" class="w-1/2" /> </span>
                        <div class="ml-3">
                ...
                <li>
                    <a class="cursor-pointer flex mb-3 p-3 items-center border border-surface-200 dark:border-surface-700 rounded hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors duration-150">
                        <span> <img src="/demo/images/avatar/circle/avatar-f-4.png" alt="Avatar" class="w-1/2" /> </span>
                        <div class="ml-3">
    ...
    >
        ...
        <div v-if="dialogMode === 'password'">
            <div class="grid grid-cols-12">
                <div class="col-span-12 mb-4 custom-password">
                    <label
                ...
                <div class="col-span-12 mb-12 custom-password">
                    <label
                ...
                <div class="col-span-12">
                    ...
                    <div class="password-rules">
                        <div
                            :class="[
                                'font-light relative flex gap-4 rule',
                                {
        ...
        <div v-else-if="dialogMode === 'verify'">
            ...
            <div class="pt-12 grid grid-cols-12 gap-4">
