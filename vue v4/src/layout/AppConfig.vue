            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap">
                    <button
                        ...
                        :class="['cursor-pointer w-6/12 h-6 rounded-full flex shrink-0 items-center justify-center p-0 outline-0 outline-offset-1', { 'outline-primary': layoutConfig.primary === primaryColor.name }]"
            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap">
                    <button
                        ...
                        :class="[
                            'cursor-pointer w-6/12 h-6 rounded-full flex shrink-0 items-center justify-center p-0 outline-0 outline-offset-1',
            ...
            <template v-if="!simple">
                ...
                <div>
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-wrap flex-col gap-12">
