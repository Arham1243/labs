...
<template>
    <div class="layout-topbar">
        ...
        <div class="topbar-end">
            <ul class="flex items-center topbar-menu">
                <li class="flex items-center topbar-profile">
                    <div v-if="cartRef?.cartsTotal > 0" class="relative">
                        <i
                ...
                <li class="flex items-center topbar-profile">
                    <div v-if="unreadNotificationsCount" class="relative">
                        <i
        ...
        <Drawer
            ...
            :pt="{
                root: {
                    style: 'width: 30rem; max-width: 30rem;'
                }
            }"
            :showCloseIcon="false"
        >
            <template #header>
                <div class="flex justify-between items-center w-full">
                    <div class="flex items-center gap-2">
                        <h4
                            class="font-bold"
                            data-testid="notification-header-sidebar"
                        >
                            Notifications
                        </h4>
                        <Badge
            ...
            <div
                class="flex flex-col justify-center items-center mt-[8px]"
            ...
            <div v-else>
                ...
                <div class="space-y-2">
                    <div v-if="loadingNotification" class="text-center mt-20">
                        loading...
                    </div>
                    <div
