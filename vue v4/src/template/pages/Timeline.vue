    ...
    <div class="card">
        ...
        <Timeline :value="customEvents" align="alternate" class="customized-timeline">
            <template #marker="slotProps">
                <span class="flex w-8/12 h-8 items-center justify-center text-white rounded-full z-10 shadow" :style="{ backgroundColor: slotProps.item.color }">
            ...
            <template #content="slotProps">
                <Card>
                    ...
                    <template #content>
                        <img v-if="slotProps.item.image" :src="'demo/images/product/' + slotProps.item.image" :alt="slotProps.item.name" width="200" class="shadow mb-12" />
                        <p>
