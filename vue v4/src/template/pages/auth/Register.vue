...
<template>
    ...
    <div class="px-20 min-h-screen flex justify-center items-center">
        <div class="border border-surface bg-surface-0 dark:bg-surface-900 rounded-border py-16 px-12 md:px-16 z-10">
            <div class="mb-12">
            ...
            <div class="flex flex-col">
                <span class="p-input-icon-left w-full mb-12">
                ...
                <div class="mb-12 flex flex-wrap">
                    ...
                    <label htmlFor="checkbox" class="text-surface-900 dark:text-surface-0 font-medium mr-2"> I have read the </label>
                    <a class="text-surface-600 dark:text-surface-200 cursor-pointer hover:text-primary cursor-pointer">Terms and Conditions</a>
                </div>
                <Button label="Sign Up" class="w-full mb-12"></Button>
                <span class="font-medium text-surface-600 dark:text-surface-200"> Already have an account? <a class="font-semibold cursor-pointer text-surface-900 dark:text-surface-0 hover:text-primary transition-colors duration-300" @click="navigateToLogin">Login</a> </span>
            </div>
        </div>
    </div>
</template>
