    ...
    <div class="px-20 min-h-screen flex justify-center items-center">
        <div class="border border-surface bg-surface-0 dark:bg-surface-900 rounded-border py-16 px-12 md:px-16 z-10">
            ...
            <div class="flex flex-col">
                <div class="flex justify-between w-full items-center mb-12 gap-12">
                    <InputNumber inputId="val1" v-model="value1" inputClass="w-full text-center" :max="9" @keyup="focus($event)"></InputNumber>
                    <InputNumber inputId="val2" v-model="value2" inputClass="w-full text-center" :max="9" @keyup="focus($event)"></InputNumber>
                    <InputNumber inputId="val3" v-model="value3" inputClass="w-full text-center" :max="9" @keyup="focus($event)"></InputNumber>
                    <InputNumber inputId="val4" v-model="value4" inputClass="w-full text-center" :max="9"></InputNumber>
                </div>
