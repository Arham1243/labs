    ...
    <div class="px-20 min-h-screen flex justify-center items-center">
        <div class="border border-surface bg-surface-0 dark:bg-surface-900 rounded-border py-16 px-12 md:px-16 z-10">
            <div class="mb-12 flex flex-col items-center">
                ...
                <span class="text-surface-600 dark:text-surface-200 font-medium mb-20">Please enter your password</span>

                <img src="/demo/images/avatar/avatar.png" class="w-full h-12 mb-2" alt="Avatar" />

                <span class="font-medium text-surface-900 dark:text-surface-0 font-medium">Isabella Andolini</span>
            </div>
