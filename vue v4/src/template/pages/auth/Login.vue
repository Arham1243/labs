    ...
    <div class="px-20 min-h-screen flex justify-center items-center">
        <div class="border border-surface bg-surface-0 dark:bg-surface-900 rounded-border py-16 px-12 md:px-16 z-10">
            ...
            <div class="flex flex-col">
                ...
                <div class="mb-12 flex flex-wrap gap-12">
                    <div>
                    ...
                    <a class="text-surface-600 dark:text-surface-200 cursor-pointer hover:text-primary cursor-pointer ml-auto transition-colors duration-300">Reset password</a>
                </div>
