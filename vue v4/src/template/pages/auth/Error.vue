...
<template>
    ...
    <div class="px-20 min-h-screen flex justify-center items-center">
        <div class="z-10 text-center">
            <div class="text-surface-900 dark:text-surface-0 font-bold text-8xl mb-12">ERROR</div>
            <p class="leading-normal mt-0 mb-20 text-surface-700 dark:text-surface-100 text-xl font-medium">Something went wrong!</p>
