...
const setChartData = () => {
    ...
    pieData.value = {
        labels: ['Students', 'Group Leaders', 'Immediate Family Members'],
        datasets: [
            {
                data: [300, 50, 100],
                backgroundColor: [
    ...
    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
        <div class="col-span-12 md:col-span-6 xl:col-span-3">
            <div class="card h-full">
                <span class="font-semibold text-lg">New Claims</span>
                <div
                    class="flex justify-between items-start mt-12"
                >
                    <div class="w-6/12">
        ...
        <div class="col-span-12 md:col-span-6 xl:col-span-3">
            <div class="card h-full">
                <span class="font-semibold text-lg">Claim Amount</span>
                <div
                    class="flex justify-between items-start mt-12"
                >
                    <div class="w-6/12">
        ...
        <div class="col-span-12 md:col-span-6 xl:col-span-3">
            <div class="card h-full">
                <span class="font-semibold text-lg">Pending Claims</span>
                <div
                    class="flex justify-between items-start mt-12"
                >
                    <div class="w-6/12">
        ...
        <div class="col-span-12 md:col-span-6 xl:col-span-3">
            <div class="card h-full">
                <span class="font-semibold text-lg">Claims Declined</span>
                <div
                    class="flex justify-between items-start mt-12"
                >
                    <div class="w-6/12">
        ...
        <div class="col-span-12 lg:col-span-8">
            <div class="card">
                ...
                >
                    <div class="text-surface-900 dark:text-surface-0 text-xl font-semibold mb-12 md:mb-0">
                    ...
                    <div class="inline-flex items-center">
                        ...
                        <Button
                            icon="pi pi-upload"
                            class="p-button-rounded mx-12 export-target-button"
                            v-tooltip="'Export'"
                            @click="exportCSV"
                        ></Button>
                    </div>
                ...
                >
                    ...
                    >
                        <template #body="{ data }">
                            ...
                            <span
                                :class="
                                    'bg-green-300 font-bold p-1 rounded-md text-green-900 product-badge status-' +
                                    data.inventoryStatus.toLowerCase()
                                "
                            >{{ 'PAID' }}</span
                            >
                        </template>
            ...
            <div class="card h-full">
                ...
                <ul class="list-none p-0 m-0">
                    <template v-for="(product, i) in products" :key="{ i }">
                        <li
                            v-if="i < 6"
                            class="flex items-center justify-between p-12"
                        >
                            <div class="inline-flex items-center">
                                <img
