    ...
    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
        ...
        <div class="col-span-12 md:col-span-6 xl:col-span-4">
            <div class="card h-full relative overflow-hidden">
                ...
                <div class="z-20 relative text-white">
                    <div class="text-xl font-semibold mb-12">Debit Card</div>
                    <div class="mb-1 font-semibold">Balance</div>
                    <div class="text-2xl mb-20 font-bold">$2.000,00</div>
        ...
        <div class="col-span-12 md:col-span-6 xl:col-span-4">
            <div class="card h-full">
                ...
                <div class="text-surface-900 dark:text-surface-0 text-2xl text-primary mb-20 font-bold">$1.500,00</div>
                <div class="flex items-center justify-between">
        ...
        <div class="col-span-12 md:col-span-6 xl:col-span-2">
            <div class="card h-full flex flex-col items-center justify-center">
                <i class="pi pi-dollar text-primary text-4xl mb-12"></i>
                <span class="text-surface-900 dark:text-surface-0 text-lg mb-12 font-medium">Primary</span>
                <span class="text-surface-900 dark:text-surface-0 text-2xl text-primary font-bold">$24,345.21</span>
            </div>
        </div>
        <div class="col-span-12 md:col-span-6 xl:col-span-2">
            <div class="card h-full flex flex-col items-center justify-center">
                <i class="pi pi-euro text-primary text-4xl mb-12"></i>
                <span class="text-surface-900 dark:text-surface-0 text-lg mb-12 font-medium">Currency</span>
                <span class="text-surface-900 dark:text-surface-0 text-2xl text-primary font-bold">$10,416.11</span>
            </div>
        </div>

        <div class="col-span-12 xl:col-span-4">
            <div class="card">
                <div class="text-surface-900 dark:text-surface-0 text-xl font-semibold mb-12">Recent Transactions</div>
                <ul class="list-none p-0 m-0">
                    <li class="flex items-center p-12 mb-12 border-b border-surface">
                        <img alt="brands" src="/demo/images/banking/airbnb.png" class="w-full shrink-0 mr-12" />
                    ...
                    <li class="flex items-center p-12 mb-12 border-b border-surface">
                        <img alt="brands" src="/demo/images/banking/amazon.png" class="w-full shrink-0 mr-12" />
                        <div class="flex flex-col">
                    ...
                    <li class="flex items-center p-12 mb-12 border-b border-surface">
                        <img alt="brands" src="/demo/images/banking/nike.svg" class="w-full shrink-0 mr-12 rounded-full" />
                        <div class="flex flex-col">
                    ...
                    <li class="flex items-center p-12 mb-12 border-b border-surface">
                        <img alt="brands" src="/demo/images/banking/starbucks.svg" class="w-full shrink-0 mr-12" />
                        <div class="flex flex-col">
                    ...
                    <li class="flex items-center p-12 mb-12">
                        <img alt="brands" src="/demo/images/banking/amazon.png" class="w-full shrink-0 mr-12" />
                        <div class="flex flex-col">
                            <span class="text-xl font-medium text-surface-900 dark:text-surface-0 mb-1">Amazon</span>
                            <span>04/12/2022</span>
        ...
        <div class="col-span-12 xl:col-span-8">
            <div class="card h-full">
                <div class="text-surface-900 dark:text-surface-0 text-xl font-semibold mb-12">Overview</div>
            ...
            <div class="card h-full">
                ...
                <div class="flex flex-col gap-y-4">
                    <div class="flex flex-col lg:flex-row gap-12">
                        <div class="w-full lg:w-6/12 p-12 border rounded-border border-surface flex items-center hover:bg-surface-100 dark:hover:bg-surface-700 cursor-pointer border-radius">
                            <img alt="avatar" src="/demo/images/avatar/circle/avatar-f-1.png" class="w-8/12 shrink-0 mr-2" />
                            <span class="text-surface-900 dark:text-surface-0 text-lg font-medium">Aisha Williams</span>
                        </div>
                        <div class="w-full lg:w-6/12 p-12 border rounded-border border-surface flex items-center hover:bg-surface-100 dark:hover:bg-surface-700 cursor-pointer border-radius">
                            <img alt="avatar" src="/demo/images/avatar/circle/avatar-f-2.png" class="w-8/12 shrink-0 mr-2" />
                            <span class="text-surface-900 dark:text-surface-0 text-lg font-medium">Jane Watson</span>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-12">
                        <div class="w-full lg:w-6/12 p-12 border rounded-border border-surface flex items-center hover:bg-surface-100 dark:hover:bg-surface-700 cursor-pointer border-radius">
                            <img alt="avatar" src="/demo/images/avatar/circle/avatar-m-1.png" class="w-8/12 shrink-0 mr-2" />
                            <span class="text-surface-900 dark:text-surface-0 text-lg font-medium">Brad Curry</span>
                        </div>
                        <div class="w-full lg:w-6/12 p-12 border rounded-border border-surface flex items-center hover:bg-surface-100 dark:hover:bg-surface-700 cursor-pointer border-radius">
                            <img alt="avatar" src="/demo/images/avatar/circle/avatar-f-3.png" class="w-8/12 shrink-0 mr-2" />
                            <span class="text-surface-900 dark:text-surface-0 text-lg font-medium">Claire Dunphy</span>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-12">
                        <div class="w-full lg:w-6/12 p-12 border rounded-border border-surface flex items-center hover:bg-surface-100 dark:hover:bg-surface-700 cursor-pointer border-radius">
                            <img alt="avatar" src="/demo/images/avatar/circle/avatar-m-2.png" class="w-8/12 shrink-0 mr-2" />
                            <span class="text-surface-900 dark:text-surface-0 text-lg font-medium">Kevin James</span>
                        </div>
                        <div class="w-full lg:w-6/12 p-12 border rounded-border border-surface flex items-center hover:bg-surface-100 dark:hover:bg-surface-700 cursor-pointer">
                            <img alt="avatar" src="/demo/images/avatar/circle/avatar-f-4.png" class="w-8/12 shrink-0 mr-2" />
                            <span class="text-surface-900 dark:text-surface-0 text-lg font-medium">Sarah McTamish</span>
                        </div>
                    </div>
                </div>

                <div class="flex flex-col sm:flex-row gap-12 mt-20">
        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="card">
                <div class="text-surface-900 dark:text-surface-0 text-xl font-semibold mb-12">Monthly Payments</div>
