    ...
    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="card">
                ...
                <i class="pi pi-bell mr-12 p-text-secondary" style="font-size: 2rem" v-badge="2"></i>
                <i class="pi pi-calendar mr-12 p-text-secondary" style="font-size: 2rem" v-badge.danger="'10+'"></i>
