            ...
            <div class="card">
                ...
                >
                    <template #value="slotProps">
                        <div
                            class="inline-flex items-center py-1 px-2 bg-primary text-primary-contrast text-primary-contrast text-primary-contrast text-primary rounded-border mr-2"
