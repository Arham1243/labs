...
<template>
    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
        <div class="col-span-12 md:col-span-6">
            ...
            <div class="card p-fluid">
                <h5>Vertical Grid</h5>
                <div class="formgrid grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
                    <div class="field col">
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="card p-fluid">
                <h5>Horizontal</h5>
                <div class="field grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
            ...
            <div class="card">
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="field col-span-12 md:col-span-3">
                        ...
                        <Select id="state" v-model="dropdownItem" :options="dropdownItems" optionLabel="name" placeholder="Select One"></Select>
                    </div>
                    <div class="field col-span-12 md:col-span-3">
