...
&#125;,</code></pre>
        ...
        <ul>
            <li class="leading-loose">Choose a custom theme name such as "mytheme".</li>
            <li class="leading-loose">Create a folder named "mytheme" under <span class="font-semibold">public/theme/theme-light/mytheme</span> folder.</li>
            <li class="leading-loose">Create a file such as theme.scss inside your "mytheme" folder.</li>
            <li class="leading-loose">Define the variables listed below in your file and import the dependencies.</li>
