<script setup>
import { ref } from 'vue';
const block1 = ref(`<div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 grid-nogutter bg-surface-0 dark:bg-surface-950 text-surface-800 dark:text-surface-50">
    <div class="col-span-12 md:col-span-6 p-12 text-center md:text-left flex items-center ">
        <section>
            ...
            <div class="text-6xl text-primary font-bold mb-12">your visitors deserve to see</div>
            <p class="mt-0 mb-12 text-surface-700 dark:text-surface-100 leading-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>

            <Button label="Learn More" type="button" class="mr-12 p-button-raised"></Button>
...
const block2 = ref(`<div class="bg-surface-0 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20 text-center">
    <div class="mb-12 font-bold text-3xl">
    ...
    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
        <div class="col-span-12 md:col-span-4 mb-12 px-20">
            <span class="p-12 shadow mb-12 inline-block bg-surface-0 dark:bg-surface-900" style="border-radius: 10px">
                <i class="pi pi-desktop text-4xl text-blue-500"></i>
            </span>
            <div class="text-surface-900 dark:text-surface-0 text-xl mb-12 font-medium">Built for Developers</div>
        ...
        <div class="col-span-12 md:col-span-4 mb-12 px-20">
            ...
            <div class="text-surface-900 dark:text-surface-0 text-xl mb-12 font-medium">End-to-End Encryption</div>
        ...
        <div class="col-span-12 md:col-span-4 mb-12 px-20">
            ...
            <div class="text-surface-900 dark:text-surface-0 text-xl mb-12 font-medium">Easy to Use</div>
        ...
        <div class="col-span-12 md:col-span-4 mb-12 px-20">
            ...
            <div class="text-surface-900 dark:text-surface-0 text-xl mb-12 font-medium">Fast & Global Support</div>
        ...
        <div class="col-span-12 md:col-span-4 mb-12 px-20">
            ...
            <div class="text-surface-900 dark:text-surface-0 text-xl mb-12 font-medium">Open Source</div>
        ...
        <div class="col-span-12 md:col-span-4 md:mb-12 mb-0 px-12">
            <span class="p-12 shadow mb-12 inline-block bg-surface-0 dark:bg-surface-900" style="border-radius: 10px">
                <i class="pi pi-shield text-4xl text-blue-500"></i>
            </span>
            <div class="text-surface-900 dark:text-surface-0 text-xl mb-12 font-medium">Trusted Securitty</div>
...
const block3 = ref(`<div class="bg-surface-50 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20">
    <div class="text-surface-900 dark:text-surface-0 font-bold text-6xl mb-12 text-center">Pricing Plans</div>
    ...
    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
        <div class="col-span-12 lg:col-span-4">
            <div class="p-12 h-full">
                <div class="shadow p-12 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                    ...
                    <hr class="my-12 mx-0 border-t border-surface-0 dark:border-surface-900 border-surface" />
                    ...
                    <hr class="mb-12 mx-0 border-t border-surface-0 dark:border-surface-900 border-surface mt-auto" />
                    <Button label="Buy Now" class="p-12 w-full mt-auto"></Button>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="p-12 h-full">
                <div class="shadow p-12 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                    ...
                    <hr class="mb-12 mx-0 border-t border-surface-0 dark:border-surface-900 border-surface" />
                    <Button label="Buy Now" class="p-12 w-full"></Button>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="p-12 h-full">
                <div class="shadow p-12 flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                    ...
                    <hr class="mb-12 mx-0 border-t border-surface-0 dark:border-surface-900 border-surface" />
                    <Button label="Buy Now" class="p-12 w-full p-button-outlined"></Button>
                </div>
            </div>
        </div>
    </div>
...
const block4 = ref(`<div class="bg-surface-0 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20">
    <div class="text-surface-700 dark:text-surface-100 text-center">
        <div class="text-blue-600 font-bold mb-12"><i class="pi pi-discord"></i>&nbsp;POWERED BY DISCORD</div>
        <div class="text-surface-900 dark:text-surface-0 font-bold text-5xl mb-12">Join Our Design Community</div>
        <div class="text-surface-700 dark:text-surface-100 text-2xl mb-20">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit numquam eligendi quos.</div>
        <Button label="Join Now" icon="pi pi-discord" class="font-bold px-20 py-12 p-button-raised p-button-rounded whitespace-nowrap"></Button>
    </div>
</div>`);

const block5 = ref(`<div class="bg-slate-900 text-gray-100 p-12 flex justify-between lg:justify-center items-center flex-wrap">
...
const block6 = ref(`<div class="bg-surface-0 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20">
    <ul class="list-none p-0 m-0 flex items-center font-medium mb-12">
        <li>
    ...
    <div class="flex items-start flex-col lg:justify-between lg:flex-row">
        <div>
            ...
            <div class="flex items-center text-surface-700 dark:text-surface-100 flex-wrap">
                <div class="mr-20 flex items-center mt-12">
...
const block7 = ref(`<div class="bg-surface-50 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20">
    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
        <div class="col-span-12 md:col-span-6 lg:col-span-3">
            <div class="bg-surface-0 dark:bg-surface-900 shadow p-12 rounded-border">
                <div class="flex justify-between mb-12">
                    <div>
                        <span class="block text-surface-500 dark:text-surface-300 font-medium mb-12">Orders</span>
        ...
        <div class="col-span-12 md:col-span-6 lg:col-span-3">
            <div class="bg-surface-0 dark:bg-surface-900 shadow p-12 rounded-border">
                <div class="flex justify-between mb-12">
                    <div>
                        <span class="block text-surface-500 dark:text-surface-300 font-medium mb-12">Revenue</span>
        ...
        <div class="col-span-12 md:col-span-6 lg:col-span-3">
            <div class="bg-surface-0 dark:bg-surface-900 shadow p-12 rounded-border">
                <div class="flex justify-between mb-12">
                    <div>
                        <span class="block text-surface-500 dark:text-surface-300 font-medium mb-12">Customers</span>
        ...
        <div class="col-span-12 md:col-span-6 lg:col-span-3">
            <div class="bg-surface-0 dark:bg-surface-900 shadow p-12 rounded-border">
                <div class="flex justify-between mb-12">
                    <div>
                        <span class="block text-surface-500 dark:text-surface-300 font-medium mb-12">Comments</span>
...
const block8 = ref(`<div class="bg-surface-0 dark:bg-surface-900 p-12 shadow rounded-border w-full lg:w-6/12">
    <div class="text-center mb-20">
        <img src="/demo/images/blocks/logos/hyper.svg" alt="Image" height="50" class="mb-12">
        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-12">Welcome Back</div>
    ...
    <div>
        ...
        <InputText id="email1" type="text" placeholder="Email address" class="w-full mb-12" />

        <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium mb-2">Password</label>
        <InputText id="password1" type="password" placeholder="Password" class="w-full mb-12" />
...
const block9 = ref(`<div class="bg-surface-0 dark:bg-surface-950">
    <div class="font-medium text-3xl text-surface-900 dark:text-surface-0 mb-12">Movie Information</div>
    <div class="text-surface-500 dark:text-surface-300 mb-20">Morbi tristique blandit turpis. In viverra ligula id nulla hendrerit rutrum.</div>
    <ul class="list-none p-0 m-0">
        <li class="flex items-center py-12 px-2 border-t border-surface flex-wrap">
        ...
        <li class="flex items-center py-12 px-2 border-t border-b border-surface flex-wrap">
...
const block10 = ref(`<div class="bg-surface-0 dark:bg-surface-900 p-12 shadow rounded-border">
    <div class="text-3xl font-medium text-surface-900 dark:text-surface-0 mb-12">Card Title</div>
    <div class="font-medium text-surface-500 dark:text-surface-300 mb-12">Vivamus id nisl interdum, blandit augue sit amet, eleifend mi.</div>
...
<template>
    <div>
        <BlockViewer header="Hero" :code="block1" free>
            <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 grid-nogutter bg-surface-0 dark:bg-surface-950 text-surface-800 dark:text-surface-50">
                <div class="col-span-12 md:col-span-6 p-12 text-center md:text-left flex items-center">
                    <section>
                        <span class="block text-6xl font-bold mb-1">Create the screens </span>
                        <div class="text-6xl text-primary font-bold mb-12">your visitors deserve to see</div>
        ...
        <BlockViewer header="Feature" :code="block2" free>
            <div class="bg-surface-0 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20 text-center">
                <div class="mb-12 font-bold text-3xl">
                    <span class="text-surface-900 dark:text-surface-0">One Product, </span>
                    <span class="text-blue-600">Many Solutions</span>
                </div>
        ...
        <BlockViewer header="Pricing" :code="block3" free>
            <div class="bg-surface-50 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20">
                <div class="text-surface-900 dark:text-surface-0 font-bold text-6xl mb-12 text-center">Pricing Plans</div>
                <div class="text-surface-700 dark:text-surface-100 text-xl mb-12 text-center leading-normal">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit numquam eligendi quos.</div>
        ...
        <BlockViewer header="Banner" :code="block5" containerClass="bg-surface-0 dark:bg-surface-950 py-20" free>
            <div class="bg-slate-900 text-gray-100 p-12 flex justify-between lg:justify-center items-center flex-wrap">
                <div class="font-bold mr-20">🔥 Hot Deals!</div>
                <div class="items-center hidden lg:flex">
                    <span class="leading-normal">Libero voluptatum atque exercitationem praesentium provident odit.</span>
                </div>
        ...
        <BlockViewer header="Sign-In" :code="block8" containerClass="bg-surface-50 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20 flex items-center justify-center" free>
        ...
        <BlockViewer header="Description List" :code="block9" containerClass="bg-surface-0 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20" free>
        ...
        <BlockViewer header="Card" :code="block10" containerClass="px-12 py-20 md:px-12 lg:px-20" free>
            <div class="bg-surface-0 dark:bg-surface-900 p-12 shadow rounded-border">
                <div class="text-3xl font-medium text-surface-900 dark:text-surface-0 mb-12">Card Title</div>
                <div class="font-medium text-surface-500 dark:text-surface-300 mb-12">Vivamus id nisl interdum, blandit augue sit amet, eleifend mi.</div>
                <div style="height: 150px" class="border-2 border-dashed border-surface"></div>
            </div>
