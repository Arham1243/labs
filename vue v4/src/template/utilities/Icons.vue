...
&lt;i class="pi pi-times"&gt;&lt;/i&gt;</code></pre>
        ...
        <InputText v-model="filter" class="w-full p-12 mt-12 mb-20" placeholder="Search an icon" />

        <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 icons-list text-center">
            <div class="col-span-6 sm:col-span-4 lg:col-span-3 xl:col-span-2 pb-20" v-for="icon of filteredIcons" :key="icon.properties.name">
