...
<template>
    <div class="card">
        <DataView :value="totalBlogs" paginator :rows="3" layout="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12" :sortOrder="sortOrder" :sortField="sortField">
            <template #header>
            ...
            <template #grid="{ data }">
                <div class="col-span-12 md:col-span-4">
                    <div class="p-12">
                        <div class="border border-surface cursor-pointer z-index rounded-border">
                            <div class="relative">
                                <img :src="data.coverImage" class="w-full" :alt="data.description.split(' ', 1)" />
                                <img :src="data.profile" class="cardImage flex absolute w-16 h-16" :alt="data.description.split(' ', 1)" />
                            </div>
                            <div class="p-12">
                                <div class="text-surface-900 dark:text-surface-0 font-semibold text-xl mb-12">{{ data.title }}</div>
                                <p class="text-surface-700 dark:text-surface-100 text-lg mt-0 mb-20">{{ data.description }}</p>
    ...
    <div class="card">
        <div class="bg-surface-0 dark:bg-surface-950 px-12 py-20 md:px-12 lg:px-20">
            <div class="font-bold text-5xl text-surface-900 dark:text-surface-0 mb-12">Recent Articles</div>
            <div class="text-surface-700 dark:text-surface-100 text-xl leading-normal mb-20">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
            <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 nogutter">
                <div class="col-span-12 lg:col-span-4 p-12">
                    <div class="border-t-4 border-blue-600"></div>
                    <div class="text-blue-600 font-medium my-2">Animals</div>
                    <div class="text-surface-900 dark:text-surface-0 font-medium text-xl leading-normal mb-12">Why Earth&lsquo;s most beloved creatures are headed toward extinction</div>
                ...
                <div class="col-span-12 lg:col-span-4 p-12">
                    ...
                    <div class="text-surface-900 dark:text-surface-0 font-medium text-xl leading-normal mb-12">Only one-third of tropical rainforests remain intact, study says</div>
                    <div class="font-sm text-surface-700 dark:text-surface-100 leading-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                    <div class="flex mt-12">
                ...
                <div class="col-span-12 lg:col-span-4 p-12">
                    ...
                    <div class="text-surface-900 dark:text-surface-0 font-medium text-xl leading-normal mb-12">Does planting a tree really offset your carbon footprint?</div>
                    <div class="font-sm text-surface-700 dark:text-surface-100 leading-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                    <div class="flex mt-12">
