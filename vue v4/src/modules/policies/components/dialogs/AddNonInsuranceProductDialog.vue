...
<template>
    <div>
        ...
        >
            ...
            <div class="p-fluid grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
                ...
                <div class="field col-span-12" v-show="selectedClient">
                    <label
                        for="business_unit"
                ...
                <div class="field col-span-12" v-if="selectedBusinessUnit">
                    <label
                        for="client"
                        data-testid="client-name-label"
                    >
