...
<template>
    <Tabs lazy value="0">
        <TabList>
            <Tab value="0">
                {{ t('policies.details.title') }}
            </Tab>
            <Tab value="1">
                {{ t('policies.details.audit_log') }}
            </Tab>
        </TabList>
        <TabPanels>
            <TabPanel value="0">
                <Loader v-if="loading" />
                <div class="grid grid-cols-12 mt-12" v-else>
                            ...
                            <template #content>
                                <div>
                                    ...
                                    <div class="grid grid-cols-12 mt-1">
                                        <div
                                            class="col-span-4 text-sm py-1 font-semibold"
                                        >
                                            {{
                                                $t(
                                        ...
                                        <div
                                            class="col-span-8 text-sm py-1 p-break-word"
                                        >
                        ...
                        <Card v-if="false">
                            <template #content>
                                <div>
                                    ...
                                    >
                                        <h5 class="mb-2">
                                            {{ $t('policies.details.pricing') }}
                                        </h5>
                                    </div>
                                    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 mt-1">
                                        <div
                                            class="col-span-3 text-sm py-1 font-semibold"
                                        >
                                            {{ $t('policies.details.base_price') }}
                                        </div>
                                        ...
                                        <div class="col-span-3 text-sm font-bold py-1">
                                            {{ $t('policies.details.grand_total') }}
                                        </div>
                                        <div class="col-span-9 text-sm font-bold py-1">
                                            {{ '$120.00' }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <div
                                            ...
                                            :key="index"
                                            class="flex justify-between items-center py-1 mb-2"
                                        >
                                            <div class="">
                                                <i
                                                ...
                                                />
                                                <Button
                                                    class="text-sm ml-12 font-bold text-primary"
                                                    link
                                                    text
...
<!--                                    </div>-->
<!--                                    <div-->
<!--                                        class="col-span-9 text-sm py-1 p-break-word"-->
<!--                                    >-->
<!--                                        {{ '58 (D)' }}-->
<!--                                    </div>-->
...
<!--    </TabView>-->
    ...
    >
        <span class="p-text-primary block mb-20">
            {{
