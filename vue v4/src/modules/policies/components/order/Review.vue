...
<template>
    <div class="mt-6">
        <div>
            ...
            <EnrollmentMessage type="warning" icon="pi-clock" class="mt-6">
                {{
                    ...
                    <div class="p-1">
                        <div class="flex justify-between">
                            <div class="flex items-center">
                                <div
                                    class="flex items-center font-weight-bold text-error"
                                ...
                                <div
                                    class="flex items-center font-weight-bold text-green"
