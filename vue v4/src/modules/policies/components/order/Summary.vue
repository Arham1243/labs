...
const tabs = computed(() => {
    ...
    return [
        ...
        {
            title: t('policies.summary.plans'),
            value: '1',
            disabled: !hasPlans
        },
        {
...
const mapPlanData = (entries, type) => {
    return Object.entries(entries).map(([planId, data]) => ({
        planId,
        type: type === 'plans' ? 'plan' : 'associated_plan',
        ...data,
        enrollments: [],
...
const loadOverview = async () => {
    ...
    planGroups.value = [
        ...mapPlanData(plans, 'plans'),
        ...mapPlanData(associated_plans, 'associated_plans')
    ];
};
            ...
            <div class="col-span-9">
                <Card class="mb-4">
                    <template #content>
                        ...
                        <!--New PrimeVue 4 TAB COMPONENT -->
                        <Tabs v-model:value="activeTab" class="enrollment-groups-tabs">
                            <TabList>
                                <Tab
                                    v-for="tab in tabs"
                                    :key="tab.value"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <template #body="{ data, index }">
                                                ...
                                                >
                                                    {{
                                                        data.type == 'plan'
                                                            ? getPlanNameById(data.planId)
                                                            : getAssociatedPlanNameById(data.planId)
                                                    }}
                                                </span>
                                            </template>
                                        </Column>
                                        ...
                                        <Column
                                            ...
                                            :header="
                                                $t('policies.summary.total_amount')
                                            "
                                        >
                                            <template #body="{ data, index }">
                                                <span
                                                    :data-testid="
                                                        'total-amount-data-table-' +
                                                        index
                                                    "
                                                >
                                                    {{
                                        ...
                                        <template #expansion="slotProps">
                                            <BaseTable
                                                ...
                                                :loading="
                                                    slotProps.data.loadingEnrollments
                                                "
                                                dataKey="id"
