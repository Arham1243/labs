...
<template>
    ...
    <div v-else class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 mt-1">
        <div class="sm:col-span-6 md:col-span-2 text-sm font-semibold py-1">
        ...
        <div class="sm:col-span-6 md:col-span-10 text-sm py-1">{{ relation }}</div>

        <div class="sm:col-span-6 md:col-span-2 text-sm font-semibold py-1">
            {{ $t('insured_overview.dependents.pay_option') }}
        </div>
        <div class="sm:col-span-6 md:col-span-10 text-sm py-1">{{ payOption }}</div>

        <div class="sm:col-span-6 md:col-span-2 text-sm font-semibold py-1">
            {{ $t('insured_overview.insured_address.address') }}
        </div>
        <div class="sm:col-span-6 md:col-span-10 text-sm py-1">{{ address }}</div>

        <div class="sm:col-span-6 md:col-span-2 text-sm font-semibold py-1">
            {{ $t('insured_overview.insured_address.address2') }}
        </div>
        <div class="sm:col-span-6 md:col-span-10 text-sm py-1">{{ address2 }}</div>

        <div class="sm:col-span-6 md:col-span-2 text-sm font-semibold py-1">
            {{ $t('insured_overview.insured_address.country') }}
        </div>
        <div class="sm:col-span-6 md:col-span-10 text-sm py-1">{{ country }}</div>

        <div class="sm:col-span-6 md:col-span-2 text-sm font-semibold py-1">
            {{ $t('insured_overview.insured_address.province') }}
        </div>
        <div class="sm:col-span-6 md:col-span-10 text-sm py-1">{{ province }}</div>

        <div class="sm:col-span-6 md:col-span-2 text-sm font-semibold py-1">
            {{ $t('insured_overview.insured_address.postal_code') }}
        </div>
        <div class="sm:col-span-6 md:col-span-10 text-sm py-1">{{ postal }}</div>

        <div class="sm:col-span-6 md:col-span-2 text-sm font-semibold py-1">
            {{ $t('insured_overview.insured_address.city') }}
        </div>
        <div class="sm:col-span-6 md:col-span-10 text-sm py-1">{{ city }}</div>
    </div>
</template>
