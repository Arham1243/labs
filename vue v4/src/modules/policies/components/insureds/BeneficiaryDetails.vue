...
<template>
    <div class="grid grid-cols-12 mt-1" v-if="isViewing">
        <div class="col-span-6 text-md font-bold px-5 py-4">
            {{ $t('policies.applicant.full_name') }}
        </div>
        <div class="col-span-6 text-md py-4 text-right">
            {{ details.full_name || '-' }}
        </div>
    ...
    <div v-else>
        <div class="mt-5 p-fluid grid grid-cols-12">
            <div class="col-span-12" v-if="bannerMessage">
