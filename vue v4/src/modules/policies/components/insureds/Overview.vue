...
<template>
    <div class="col-span-12">
        <Message class="h-14 mb-4" severity="info" icon="pi pi-exclamation-circle" :closable="false">
    ...
    >
        ...
        <div class="mt-2 flex flex-col items-stretch gap-2" v-else>
            <ItemCard
            ...
            >
                <template #title="{ onClick }">
                    <a class="item-link p-0 shadow-none text-lg text-left p-break-all cursor-pointer"
