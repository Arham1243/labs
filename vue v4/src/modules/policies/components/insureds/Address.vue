...
<template>
    ...
    <div class="p-fluid formgrid grid grid-cols-12 mt-5" v-if="isEditing">
    ...
    <div class="grid grid-cols-12 mt-1" v-else>
        <div
        ...
        <div class="sm:col-span-6 md:col-span-8 text-sm py-1" data-testid="address">
            {{ address }}
        </div>
        <div
            class="sm:col-span-6 md:col-span-4 text-sm font-semibold py-1"
        ...
        <div class="sm:col-span-6 md:col-span-8 text-sm py-1" data-testid="address2">
            {{ address2 }}
        </div>
        <div
            class="sm:col-span-6 md:col-span-4 text-sm font-semibold py-1"
        ...
        <div class="sm:col-span-6 md:col-span-8 text-sm py-1" data-testid="country">
            {{ country }}
        </div>
        <div
            class="sm:col-span-6 md:col-span-4 text-sm font-semibold py-1"
        ...
        <div class="sm:col-span-6 md:col-span-8 text-sm py-1" data-testid="province">
            {{ province }}
        </div>
        <div
            class="sm:col-span-6 md:col-span-4 text-sm font-semibold py-1"
        ...
        <div class="sm:col-span-6 md:col-span-8 text-sm py-1" data-testid="city">
            {{ city }}
        </div>
        <div
            class="sm:col-span-6 md:col-span-4 text-sm font-semibold py-1"
        ...
        <div class="sm:col-span-6 md:col-span-8 text-sm py-1" data-testid="postal-code">
            {{ postalCode }}
        </div>
    </div>
</template>
