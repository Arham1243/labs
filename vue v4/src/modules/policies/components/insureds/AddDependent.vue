...
<template>
    <div class="p-fluid grid grid-cols-12 gap-3">
        <div class="field col-span-12 mb-0">
        ...
        <div class="field col-span-12 mb-0" v-if="dependent?.dependent_id">
            <label
        ...
        <div class="field col-span-12 mb-0" v-if="dependent?.parent_policy_id">
            <label
        ...
        <div class="col-span-12 mb-0" v-if="dependent.isEnforced">
