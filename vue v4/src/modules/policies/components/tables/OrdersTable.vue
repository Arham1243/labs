...
<template>
    ...
    >
        <template #header>
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="flex justify-between items-center gap-12 w-80">
                    <Search
        ...
        >
            <template #body="{ data, index }">
                <span
                    class="underline text-blue-900 font-bold cursor-pointer"
    ...
    >
        ...
        <div class="flex items-center gap-12 mb-12">
            <label for="booking-date" class="font-semibold w-32">{{
                $t('policies.orders_table.booking_date')
            }}</label>
            <DatePicker v-model="selectedItem.confirmed_at" />
        </div>
