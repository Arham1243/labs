...
import * as GenderService from '@/modules/administration/services/Gender.service';

export const searchGenderMock = () =>
    vi.spyOn(GenderService, 'search').mockResolvedValue({
        data: {
            data: [
                {
