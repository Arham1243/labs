...
<template>
    ...
    >
        ...
        <Column :sortable="true" field="updated_at" class="w-2/12">
            <template #header>
    ...
    >
        ...
        <div class="grid grid-cols-12 gap-2">
            <div class="field col-span-12 mb-2">
                <label
            ...
            <div class="field col-span-12 mb-14">
                <label
            ...
            >
                ...
                <div class="flex  justify-end edit-cancel-button">
                    <Button
