...
<template>
    ...
    >
        <template #header>
            <div class="flex justify-between items-center mb-2 custom-search">
                <Search
                    v-model="search"
                    :style="{ width: '30vw' }"
        ...
        <Column :sortable="false" field="name" class="p-break-all w-2/12">
            <template #header>
        ...
        <Column :sortable="false" field="cron" class="p-break-all w-2/12">
            <template #header>
                <span
    ...
    >
        <template #header>
            <div
                class="flex items-center justify-between w-full pb-2 edit-cancel-button"
            >
                <div
