...
export default [
    {
        ...
        children: [
            ...
            {
                path: 'non-insurance-product-types',
                name: 'Non-Insurance Product Types',
                component: () =>
                    import(
                        '@/modules/administration/views/non-insurance-product-type/index.vue'
                    ),
                meta: {
                    breadcrumb: [
                        'Administration',
                        'Non-Insurance Product Types'
                    ]
                }
            },
            {
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                '@/modules/administration/views/communication-templates/list.vue'
                            ),
                        meta: {
                            breadcrumb: [
                                'Administration',
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                '@/modules/administration/views/communication-templates/new.vue'
                            ),
                        meta: {
                            breadcrumb: [
                                'Administration',
                            ...
                            permission: 'create communication templates'
                        }
                    },
                    {
                        path: ':id/edit',
                        ...
                        component: () =>
                            import(
                                '@/modules/administration/views/communication-templates/edit.vue'
                            ),
                        meta: {
                            breadcrumb: [
                                'Administration',
