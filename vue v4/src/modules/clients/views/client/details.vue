        ...
        <div class="col-span-9">
            <Header @goBack="goBack">
                <template #title>
                    ...
                    >
                        {{ lodash.truncate(helpers.getLocaleValue(item.name), { length: 30 }) }}
                    </div>
            ...
            <Tabs :lazy="true" :value="activeTabIndex">
                <TabList class="custom-tab">
                    ...
                    >Business Units</Tab>
                    <Tab
                        :value="$ability.can('view business units') ? 1 : 0"
                    >Documents</Tab>
                    <Tab
                        :value="$ability.can('view business units') ? 2 : 1"
                    >Contacts</Tab>
                    <Tab
                        v-if="$ability.can('view client users')"
                        :value="$ability.can('view business units') ? 3 : 2"
                    >Users</Tab>
                    <Tab
                        :value="$ability.can('view business units') && $ability.can('view client users') ? 4 : $ability.can('view business units') || $ability.can('view client users') ? 3 : 2"
                    >Audit Log</Tab>
                    <Tab
                        v-if="viteShowInsuredsTab"
                        :value="$ability.can('view business units') && $ability.can('view client users') ? 5 : $ability.can('view business units') || $ability.can('view client users') ? 4 : 3"
                    >Insureds</Tab>
                </TabList>
                <TabPanels>
                    <TabPanel
                    ...
                    <TabPanel :value="$ability.can('view business units') ? 1 : 0">
                        <div class="mt-4">
                            Documents
                        </div>
                    </TabPanel>
                    <TabPanel :value="$ability.can('view business units') ? 2 : 1">
                        <div class="mt-4">
                            <Card>
                                <template #content>
                    ...
                    <TabPanel :value="$ability.can('view business units') && $ability.can('view client users') ? 4 : $ability.can('view business units') || $ability.can('view client users') ? 3 : 2">
                        <div class="mt-4">
                            <Card>
                                <template #content>
