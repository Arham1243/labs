...
<template>
    <Loader v-if="loading" />
    <div v-else class="grid grid-cols-12 gap-4 mt-12">
        <div class="col-span-9">
            ...
            <Tabs :lazy="true" v-model:value="activeTab">
                <TabList class="custom-tab">
                    <Tab v-if="$ability.can('view clients')" :value="0">Clients</Tab>
                    <Tab :value="$ability.can('view clients') ? 1 : 0">Documents</Tab>
                    <Tab :value="$ability.can('view clients') ? 2 : 1">Users</Tab>
                    <Tab :value="$ability.can('view clients') ? 3 : 2">Audit Log</Tab>
                </TabList>
                <TabPanels>
                    <TabPanel v-if="$ability.can('view clients')" :value="0">
                    <Card
                    ...
                    <TabPanel :value="$ability.can('view clients') ? 1 : 0">
                        <div class="mt-4">Documents</div>
                    </TabPanel>
                    <TabPanel :value="$ability.can('view clients') ? 2 : 1">
                        <div class="mt-4">Users</div>
                    </TabPanel>
                    <TabPanel :value="$ability.can('view clients') ? 3 : 2">
                        <Card class="mt-7">
                            <template #content>
                                <AuditTable
                                    entity="holding"
