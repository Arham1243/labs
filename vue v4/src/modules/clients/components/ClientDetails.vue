...
<template>
    ...
    <div v-else>
        ...
        <div v-else class="grid grid-cols-12 mt-4 gap-2">
            <div
            ...
            <div class="col-span-9 text-sm p-break-word">
            ...
            <div class="col-span-9 text-sm gap-1">
                <i
                    :class="
            ...
            <div v-if="variant === 'client'" class="col-span-9 text-sm">
            ...
            <div class="col-span-9 text-sm">{{ item.phone_number }}</div>
            <div
            ...
            <div class="col-span-9 text-sm">{{ item.website_url }}</div>
            <div
            ...
            <div v-if="variant === 'businessUnit'" class="col-span-9 text-sm">
