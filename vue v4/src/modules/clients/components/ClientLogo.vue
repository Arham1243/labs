...
<template>
    <div>
        <div class="flex justify-between items-center mb-4 edit-cancel-button">
            <h5 data-testid="client-logo-title">
                {{
                    variant === 'client'
        ...
        >
            ...
            >
                <i class="pi pi-cloud-upload mb-12" style="font-size: 3rem"></i>
            ...
            />
            <div v-if="fileError" class="w-full my-4">
                <InputField
                    variant="message"
                    severity="error"
                    :closable="false">
        ...
        <div v-if="selectedFile" class="file-preview flex col-span-12 p-0">
            <div class="col-span-7 p-0">
                <img
            ...
            <div
                ...
                class="col-span-5 p-0 flex flex-row gap-2 items-center justify-center"
            >
                <Button
                    label="Re-upload"
                    class="p-button-outlined w-48"
                    icon="pi pi-refresh"
                    @click="handleUpload"
                />
                <Button
