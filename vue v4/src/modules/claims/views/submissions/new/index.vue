...
import {scrollUp} from "@/modules/claims/utils/helper.js";
...
<template>
    <div v-if="currentInsured && currentPolicy && formData.country?.id">
        <template v-if="route.name === 'New Submission'">
            ...
            <div class="grid grid-cols-12 mt-6">
                <div class="col-span-8 col-start-3">
                    <div class="card">
                        <div class="pb-1 mb-5 border-b border-gray-300">
                    ...
                    <div class="card mx-auto py-12">
                        <h4>Location</h4>
                        <div class="grid grid-cols-12 gap-x-6 gap-y-3 py-4">
                            <LabelField
            ...
            <div class="grid grid-cols-12">
                <section class="col-span-8 col-start-3">
                    <div class="mb-6">
                        ...
                        <div class="text-gray-500 mt-1" data-testid="text-policy-number">
                            {{ $t('policies.policy_number') }}:
                            {{ currentInsured.policies?.[0]?.policy_number }}
                        </div>
                    </div>

                    <Stepper :value="pageIndex()+1">
                      <StepList class="[&_.p-step-header]:flex [&_.p-step-header]:flex-col [&_.p-step-active_.p-step-number]:bg-blue-900 [&_.p-step-active_.p-step-number]:text-white [&_.p-stepper-separator]:-mx-16  [&_.p-stepper-separator]:-mt-7">
                        <Step v-for="({label, to}, i) in stepperItems" :key="label" :value="i+1" @click="router.push(to)">{{label}}</Step>
                      </StepList>
                    </Stepper>
        ...
        <div class="grid grid-cols-12 mt-12 pb-20">
            <div
                class="col-span-8 col-start-3 flex justify-between items-center"
            >
                <Button
