...
<template>
    ...
    <div class="card mt-6">
        <template v-for="field in getFields()" :key="field.label">
            ...
            <div v-if="field?.condition?.[formData.payee]" class="grid grid-cols-12 gap-x-6">
                <divider class="!my-6 col-span-12" />
                <h4
                    class="text-xl mb-4 col-span-12"
                ...
                <p
                    ...
                    class="text-justify col-span-12"
                ...
                >
                    ...
                    >
                        <divider class="!my-6 col-span-12" />
                        <h4
                            class="text-xl my-4 col-span-12"
                            v-text="
                    ...
                    <div v-if="formData.payee_opt" class="col-span-12">
                        <divider class="!my-6" />
                        <h4
                            class="text-xl mb-4"
    ...
    >
        ...
        <div class="flex justify-end gap-2 mt-8 mb-3">
            <Button
                type="button"
                label="Cancel"
                link
