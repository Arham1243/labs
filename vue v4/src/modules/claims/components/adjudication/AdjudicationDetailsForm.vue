...
<template>
    <div class="grid grid-cols-12 gap-2" data-testid="form-adjudication-details">
        <LabelField
        ...
        <div class="col-span-12 flex items-center gap-2" data-testid="text-audit-frequency">
            Send claims for audit, every &nbsp;
            <InputNumber
                v-model="formData.audit_frequency"
                class="w-16"
                :class="{ 'border-red-500 border border-round': freq_error }"
                :min="0"
