    ...
    >
        ...
        <div class="mt-10">
            <template v-for="(f, i) in filters" :key="i">
                <div class="mb-8">
                    <div class="grid grid-cols-12 gap-8 px-5">
                        <div class="col-span-1">
                            <Badge
                                :value="i + 1"
                                class="font-bold !w-[1.85rem] !h-[1.85rem] !text-[1.03rem]"
                            />
                        </div>
                        ...
                        <div class="col-span-4">
                            ...
                            <ApiMultiselect
                                ...
                                @update:modelValue="
                                    (val) => onMultiSelect(i, val)
                                "
                            />
                            <div
                                v-if="isCustom(f.operator)"
                                class="grid grid-cols-2 gap-8 mt-6 mb-5"
                            >
                                <div>
                                    <label class="mb-2">
                        ...
                        <div class="col-span-1">
                            <Button
                                ...
                                severity="danger"
                                rounded
                                class="w-[2.3rem] h-[2.3rem]"
                                :disabled="busy"
                                @click="removeFilter(i)"
                            />
                        </div>

                        <div class="col-span-2" v-if="i < filters.length - 1">
                            <InputField
