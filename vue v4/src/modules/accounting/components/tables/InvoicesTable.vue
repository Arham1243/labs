...
onBeforeMount(() => {
    ...
    const storedTab = invoicesStore.getFromLocal(selectedTabStorageKey.value);
    // Default to 0 (Unpaid tab) if no stored value or if it's an empty array
    activeTabIndex.value =
        storedTab === null ||
        storedTab === undefined ||
        (Array.isArray(storedTab) && storedTab.length === 0)
            ? 0
            : storedTab;
});
</script>
    ...
    <div>
                ...
                >
                    <div class="flex items-center gap-2">
                        ...
                        <Badge
                            v-if="tab.count"
                            :class="{
                                'inactive-badge': activeTabIndex !== tab.value
                            }"
                            :value="tab.count"
                            :severity="
        ...
        >
            <template #header>
                ...
                <div
                    :class="[
                        filters.length > 0 ? 'mt-5 pt-2' : 'mt-10 pt-4',
                        'mb-2 '
                    ]"
...
<style scoped>
:deep(.invoice-tabs span.p-tablist-active-bar) {
