...
<template>
    ...
    <Tabs :value="activeTabIndex">
        <TabList class="custom-tab">
            ...
            <Tab :value="1" @click="handleTabClick(1)">Services</Tab>
            <Tab :value="2" @click="handleTabClick(2)">{{ $t('common.pricing') }}</Tab>
            <Tab :value="3" @click="handleTabClick(3)">Documents</Tab>
            <Tab :value="4" @click="handleTabClick(4)">Audit Log</Tab>
        </TabList>
        <TabPanels>
            <TabPanel :value="0">
                <div class="grid grid-cols-12 mt-4" v-if="item.id">
