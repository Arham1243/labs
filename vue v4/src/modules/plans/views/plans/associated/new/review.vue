...
<template>
    ...
    <div v-else class="mx-20 mt-12">
        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            <div v-if="['dependants'].includes(formData.category?.code)" class="col-span-12">
                    <Card>
                        <template #content>
                            <DependantSettings
                                :data="formData"
            ...
            <div class="col-span-12 mt-12 flex justify-between items-center">
                    <Button
