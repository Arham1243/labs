...
<template>
    ...
    <Accordion :value="activeIndexes" multiple>
        <AccordionPanel v-for="(service, index) in addedServices" :key="index" :value="index">
            <AccordionHeader>
            ...
            <AccordionContent>
                <div class="m-0">
                    <Tabs value="0">
                        <TabList>
                            <Tab value="0">Included (19)</Tab>
                            <Tab value="1">Excluded (0)</Tab>
                        </TabList>
                        <TabPanels>
                            <TabPanel value="0">
                                <div class="mt-20">
                                        ...
                                        <template v-if="!readonly" #header>
                                            ...
                                            >
                                                ...
                                                <Menu
                                                    ...
                                                    :popup="true"
                                                />
                                                <span class="p-input-icon-left ml-12">
                            ...
                            <TabPanel value="1">
                                <div class="mt-20">
                                    ...
                                    >
                                        ...
                                        <Column field="include">
                                            <template #header>
                                                <div class="text-center">Include</div>
                                            </template>
                                            <template #body>
                                                <div class="text-center">
                                                    <Button
