...
<template>
    ...
    <div v-else>
        ...
        <div class="my-6 flex justify-between items-center">
            ...
            <div v-if="props.store.currentPlan?.total_attached_benefits > 0" class="edit-cancel-button">
                <Button
                    v-if="isNew"
                ...
                <Button
                    ...
                    label="Remove All"
                    icon="pi pi-times"
                    class="p-button-text p-button-danger ml-12"
        ...
        <Accordion
            :value="isNew ? activeIndexes : activeIndexesDetails"
            multiple
        ...
        >
            ...
            <span class="flex justify-between items-center gap-2 w-full">
                ...
                <div class="flex items-center">
                    ...
                    <template v-if="isEditable" class="edit-cancel-button">
                        <Button
                            :label="
                                benefitGroup.pivot?.coverage ||
                                benefitGroup.pivot?.max_amount
            ...
            <AccordionPanel v-if="hasIndividualBenefits" value="individual-benefits">
                <AccordionHeader>
            <span class="flex justify-between items-center gap-2 w-full">
                <div class="ml-2">
                    <h5>{{ $t('common.individual_benefits') }}</h5>
                </div>
                <div class="flex items-center edit-cancel-button" v-if="isEditable">
                    <Button
                        icon="pi pi-times"
                        size="small"
