...
<template>
    ...
    <div v-else class="grid mt-1">
        <div class="col-span-12">
            <div class="custom-select-button-sm my-6">
                <InputField
            ...
            <div v-if="isAlternateInsurance">
                <Divider align="left" class="font-bold">{{t('plans.opt_out_form_Custom_website') }}</Divider>
                <div class="col-span-12 my-8">
                    <div
                        ...
                        "
                    >
                        <div class="flex gap-8 col-span-12 my-4">
                ...
                <Divider align="left" class="font-bold">{{t('plans.opt_out_dates_between_policies') }}</Divider>

                <div class="col-span-2 mt-8 mb-10">
                    <div
                        v-if="
                ...
                <div class="grid grid-cols-12 mt-8 mb-2">
                    <div class="col-span-3">Requires alternate insurance info</div>
                ...
                <div
                    v-if="alternateInsuranceData.requires_alternate_insurance_info"
                    class="grid grid-cols-12 mb-2"
                >
                    <div class="col-span-3">Approved plans</div>
                    <!-- This return is temporary | Platform team will develop this part -->
                    <div class="col-span-9">N/A</div>
                </div>

                <div class="grid grid-cols-12 mb-2">
                    <div class="col-span-3">Allow opt out resubmissions</div>
                    <div class="col-span-9">
                        <span
                            v-if="
                ...
                <div class="grid grid-cols-12 mb-2">
                    <div class="col-span-3">Requires proof of coverage</div>
                    <div class="col-span-9">
                        <span
                            v-if="
                ...
                <div class="grid grid-cols-12 mb-2">
                    <div class="col-span-3">Allow direct refund</div>
                    <div class="col-span-9">
                        <span
                            v-if="
                ...
                <div class="grid grid-cols-12 mb-2">
                    <div class="col-span-3">Allow late opt outs</div>
                    <div class="col-span-9">
