...
<template>
    ...
    <div class="mt-8 mb-10 custom-select-button">
        <InputField
    ...
    <div v-if="isDataVisibilityTypeFixed" class="col-span-12">
    ...
    <div class="mb-5">{{ t('plans.opt_out_eligibility_text') }}</div>
    ...
    <div>
        ...
        <div
            ...
            class="radio-options-container mt-6"
            role="radiogroup"
        >
            <div class="flex flex-row items-center gap-4 ml-4 mb-6">
                <div
    ...
    <div class="flex">
        <div class="flex-1">
            ...
            >
                <div class="mt-5">
                    <label class="mb-2">{{ t('plans.approved_plans') }}</label>
                    <InputField
                        variant="chips"
                        :placeholder="
