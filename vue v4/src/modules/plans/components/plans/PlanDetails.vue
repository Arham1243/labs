...
<template>
    ...
    <div v-else class="grid grid-cols-12 mt-1">
        <div class="col-span-3 text-sm font-semibold py-1">Plan Name</div>
        ...
        <div class="col-span-3 text-sm font-semibold py-1">Domestic</div>
        <div class="col-span-9 text-sm py-1 p-break-word">
        ...
        <div class="col-span-3 text-sm font-semibold py-1">Inbound</div>
        <div class="col-span-9 text-sm py-1 p-break-word">
