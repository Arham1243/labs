...
<template>
    <div class="grid grid-cols-12">
        <div class="col-span-12 grid grid-cols-2 gap-x-4 mb-4">
            <div>
                <label for="policy_term" class="block mb-2">{{ $t('plans.policy_term') }} *
                    <i v-tooltip="$t('plans.policy_term_tooltip')" class="pi pi-info-circle"></i>
                </label>
            ...
            <div>
                <label for="enrolment_period" class="block mb-2">{{ $t('plans.enrolment_period') }}
                    <i v-tooltip="$t('plans.enrolment_period_tooltip')" class="pi pi-info-circle"></i>
                </label>
                <div class="flex items-center gap-x-2">
                    <InputField
                        id="enrolment_period"
        ...
        <div class="col-span-12 grid grid-cols-2 gap-x-4">
            <div>
                <label for="minimum_age" class="block mb-2">{{ $t('plans.main_applicant_minimum_age') }}</label>
                <div class="flex items-center gap-x-2">
                    <InputField
                        id="minimum_age"
                        variant="number"
            ...
            <div>
                <label for="maximum_age" class="block mb-2">{{ $t('plans.main_applicant_maximum_age') }}</label>
                <div class="flex items-center gap-x-2">
                    <InputField
                        id="maximum_age"
                        variant="number"
        ...
        <div class="col-span-12">
            ...
            <div v-if="showFormatBuilder">
                <div class="col-span-12">
                    ...
                    <div
                        class="my-4 p-4 bg-gray-100 border border-black/10 rounded-border overflow-x-auto"
                    >
                        {{ formatPreview }}
                    </div>
                </div>
